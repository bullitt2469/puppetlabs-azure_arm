...
Puppet::Type.type(:azure_shared_access_authorization_rule_resource).provide(:arm) do
  ...
  def self.invoke_list_with_params(resource = nil, body_params = nil)
    ...
    self.call_op(path_params, query_params, header_params, body_params, "management.usgovcloudapi.net", "/subscriptions/%{subscription_id}/resourceGroups/%{resource_group_name}/providers/Microsoft.NotificationHubs/namespaces/%{namespace_name}/AuthorizationRules", "Get", "[application/json]")
  end
